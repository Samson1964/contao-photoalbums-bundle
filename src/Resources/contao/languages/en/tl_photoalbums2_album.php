...
$GLOBALS['TL_LANG']['tl_photoalbums2_album']['imageSort'] = array('Sort images', 'Drag the images into the desired order with the mouse. The keyboard works too: click an image and move it with Ctrl and the arrow keys. The order is applied when you save the album.');
