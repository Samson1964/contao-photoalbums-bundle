...
$GLOBALS['TL_LANG']['tl_photoalbums2_album']['images'] = array('Fotos und Videos', 'Wählen Sie hier die Fotos und Videos aus, die in diesem Album angezeigt werden sollen. Ein Video bekommt eine einheitliche Vorschaukachel und wird beim Anklicken abgespielt.');
...
$GLOBALS['TL_LANG']['tl_photoalbums2_album']['previewImage'] = array('Vorschau Foto auswählen', 'Wählen Sie hier das Vorschau Foto aus. Zur Auswahl stehen nur Fotos — ein Video ergäbe als Aufmacher nur die Platzhalterkachel.');
...
$GLOBALS['TL_LANG']['tl_photoalbums2_album']['imageSort'] = array('Fotos sortieren', 'Ziehen Sie die Fotos und Videos mit der Maus in die gewünschte Reihenfolge. Mit der Tastatur geht es auch: Kachel anklicken und mit Strg und den Pfeiltasten verschieben. Übernommen wird die Reihenfolge erst beim Speichern des Albums.');
