...
$GLOBALS['TL_LANG']['tl_photoalbums2_album']['imageSort'] = array('Fotos sortieren', 'Ziehen Sie die Fotos mit der Maus in die gewünschte Reihenfolge. Mit der Tastatur geht es auch: Foto anklicken und mit Strg und den Pfeiltasten verschieben. Übernommen wird die Reihenfolge erst beim Speichern des Albums.');
